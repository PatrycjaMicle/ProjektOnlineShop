...
public class TowarController : ControllerBase
{
    ...
    {
        if (_context.Towars == null) return NotFound();
    ...
    {
        if (id != towar.IdTowaru) return BadRequest();
    ...
    {
        if (_context.Towars == null) return Problem("Entity set 'SklepInternetowyContext.Towars'  is null.");
