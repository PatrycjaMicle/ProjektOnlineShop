...
public class UzytkownikController : ControllerBase
{
    ...
    {
        if (_context.Uzytkowniks == null) return NotFound();
    ...
    {
        if (id != uzytkownik.IdUzytkownika) return BadRequest();
    ...
    {
        if (_context.Uzytkowniks == null) return Problem("Entity set 'SklepInternetowyContext.Uzytkowniks'  is null.");
