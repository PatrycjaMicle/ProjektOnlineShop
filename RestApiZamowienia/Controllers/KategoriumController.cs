...
public class KategoriumController : ControllerBase
{
    ...
    {
        if (_context.Kategoria == null) return NotFound();
    ...
    public async Task<ActionResult<Kategorium>> GetKategorium(int id)
    {
        ...
        if (kategorium == null) return NotFound();
    ...
    {
        if (id != kategorium.IdKategorii) return BadRequest();
    ...
    {
        if (_context.Kategoria == null) return Problem("Entity set 'SklepInternetowyContext.Kategoria'  is null.");
