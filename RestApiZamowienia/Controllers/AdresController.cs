...
public class AdresController : ControllerBase
{
    ...
    {
        if (_context.Adres == null) return NotFound();
    ...
    {
        if (id != adre.IdAdresu) return BadRequest();
    ...
    {
        if (_context.Adres == null) return Problem("Entity set 'SklepInternetowyContext.Adres'  is null.");
